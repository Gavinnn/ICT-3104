...
(1, 'JCube, Jurong East', 100, '2 Jurong East Central 1, Singapore 609732'),
(2, 'AMK Hub', 100, '53 Ang Mo Kio Avenue 3, 569933'),
(3, 'Sembawang Home Team NS', 0, '301 Canberra Rd, 759774'),
(4, 'Toa Payoh Community Club', 0, '471 Lorong 4 Toa Payoh, 310292'),
(5, 'TPY Hub', 0, '480 Lorong 6 Toa Payoh, 310481');
...
(1, 1, 'Dylan', 'Dylan', 'deeeeeeeeeeelan@hotmail.com', 99999999, '61775b8dba79b3c9ed889786b97508bd', 2, b'1'),
...
--
ALTER TABLE `user`
 ADD PRIMARY KEY (`userID`), ADD UNIQUE KEY `email` (`email`), ADD UNIQUE KEY `userName` (`userName`), ADD UNIQUE KEY `email_2` (`email`), ADD KEY `status` (`status`), ADD KEY `roleID` (`roleID`), ADD KEY `status_2` (`status`), ADD KEY `roleID_2` (`roleID`);
...
--
ALTER TABLE `groupsessions`
MODIFY `groupSessionID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
