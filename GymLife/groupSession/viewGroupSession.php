                                ...
                                <table id="groupSession" class="table table-striped table-bordered table-list" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($record as $row) {
                                            ...
                                            echo "<button class='btn btn-success' onclick=\"location.href ='approveSession.php?id=" . $row['groupSessionID'] . "&approve=2' \">Approve</button> &nbsp;";
                                            echo "<button class='btn btn-danger' onclick=\"location.href ='approveSession.php?id=" . $row['groupSessionID'] . "&approve=3' \">Reject</button>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                        ?>
