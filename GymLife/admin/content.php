...
<html lang="en">
    <head>
        <!-- Basic -->
        <title>GymLife | Content Management</title>
        <!-- Define Charset -->
        <meta charset="utf-8">
        <!-- Responsive Metatag -->
            ...
            function dlt(id)
            {
                swal({
                    ...
                    closeOnCancel: true},
                        function (isConfirm) {
                            if (isConfirm) {
                                location.href = 'deleteContent.php?id=' + id;
                            }
                        });
            }
        </script>
    ...
    <body>
        ...
        <section id="about-section" class="about-section">
            <div class="container">
                <div class="row">
				&nbsp;&nbsp;&nbsp;<button type="button" class="btn" onclick="location.href='addContent.php'"><span class="glyphicon glyphicon-plus"></span>  Add Content</button>
				<br><br>
                    <div class="col-md-12">
                        <div class="panel panel-default panel-table">
                            ...
                            <div class="panel-body">
                                <table id="trainings" class="table table-striped table-bordered table-list" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="col-md-1">Content No</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $record = DB::query("SELECT * FROM info");
                                        ...
                                        foreach ($record as $row) {
                                            ...
                                            echo "<td>";
                                            echo "<button class='btn btn-warning' onclick=\"location.href ='editContent.php?id=" . $row['infoID'] . "' \">Edit</button> &nbsp;";
                                            echo "<button class='btn btn-danger' onclick='dlt(\"" . $row['infoID'] . "\")'>Delete</button>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                        ?>
