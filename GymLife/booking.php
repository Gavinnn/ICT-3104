            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center wow fadeInDown" data-wow-duration="2s" data-wow-delay="50ms">
                            <h2>Our Trainers</h2>
                            <p>Engage our qualified trainers today to work for a healthier life.</p>
                        </div>                        
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="col-md-3">
                    <div class="services-post">
                        ...
                        <p>Complete fitness training that addresses all aspects of body fitness.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="services-post">
                        ...
                        <p>Specifically designed to work on body resistance to induce muscular contraction to build strength and muscles.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="services-post">
                        ...
                        <p>High intensity cardio workouts for burning fats.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="services-post">
                        ...
                        <h2>Kick Boxing</h2>
                        <p>Trained in combination with ground fighting disciplines to make for a complete fighting style.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="services-post">
                ...
                <div class="col-md-3">
                    <div class="services-post">
                        ...
                        <h2>Boxing</h2>
                        <p>Boxing workouts and exercises to improve your fighting ability.</p>
                    </div>
                </div>
            </div>
        </div>
